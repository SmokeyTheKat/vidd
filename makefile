...
CC := clang
LIBS :=
CFLAGS := $(if $(uselibfmt), -DUSE_LIBFMT,) $(if $(default-mode-insert), -DVIDD_DEFAULT_MODE_INSERT,) -std=c++20 -O3 -Wall -Wextra -Wno-unused-parameter -I./include/ -DPREFIX=\"$(shell realpath $(PREFIX))\"
